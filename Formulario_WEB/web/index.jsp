<%-- 
    Document   : index
    Created on : 2/10/2024, 7:15:37 p. m.
    Author     : melis
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <input type="text" name="txt_direccion" id="txt_direccion" class="form-control" placeholder="Ejemplo: # Casa Calle Ciudad" required>
            ...
            <select name="drop_puesto" id="drop_puesto" class="form-control">
                ...
                <button name="btn_agregar" id="btn_agregar" value="agregar" class="btn btn-primary">Agregar</button>
                 ...
                 <button name="btn_eliminar" id="btn_eliminar" value="eliminar" class="btn btn-secondary">Eliminar</button>
                                            </tr>
